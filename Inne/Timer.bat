...
rem Skrypt ma za zadanie otwierać się wraz z systemem w tle, stworzyć dwa ukryte plik przechwoująca datę jeden date uruchomienia drugi pozostałe minuty
rem odlicza 2 godziny od uruchomienia komputera zapisując wartość pozostałych minut co minutę na wypade zamknięcia w przypadku uruchomienia programu w dzień inni niż ostatni licznik minut się odnawia
